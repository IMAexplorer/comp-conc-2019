...
atomic_int s = 0; //variavel compartilhada entre as threads
...
int main(int argc, char *argv[]) {
    ...
    pthread_t tid[NTHREADS];Valor de s = 14745106
user4@machine:~/Projects/UFRJ/comp-conc-2019/cods-lab5$ ./ex2
